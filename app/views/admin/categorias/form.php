            ...
            <div class="card-body">
                <form id="formCategoria" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <span class="input-group-text">
                                <i id="iconoPreview" class="<?php echo $esEdicion && !empty($categoria['icono']) ? htmlspecialchars($categoria['icono']) : 'bi-image'; ?>"></i>
                            </span>
                            <input type="text"
                                   class="form-control"
                                   id="icono"
                    ...
                    <div class="mb-3">
                        ...
                        <?php if ($esEdicion && !empty($categoria['imagen'])): ?>
                        <div class="mt-2">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="form-check form-switch mt-2">
                                <input class="form-check-input"
                                       ...
                                       id="activo"
                                       name="activo"
                                       <?php echo (!$esEdicion || !empty($categoria['activo'])) ? 'checked' : ''; ?>>
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-2">
                    ...
                    <strong class="h4 mb-0 text-primary"><?php echo $stats['total_productos'] ?? 0; ?></strong>
                </div>
                <hr>
